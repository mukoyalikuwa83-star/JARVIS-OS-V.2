...
EXPECTED_TOOLS = {
    ...
    "file_processor", "create_presentation", "deep_research", "task_status", "save_memory",
    "system_info", "bluetooth_control", "wifi_control", "calendar_control", "autonomous_control",
    "market_monitor", "daily_briefing", "contact_manager", "taskbar_detect", "full_control", "cybersec",
    "screen_auto", "monitor", "cleanup", "sing", "proactive_tasks", "phone_control",
    "coding_assistant", "learning_memory", "notification_center", "clipboard_manager", "alarm_timer",
    "smart_assistant", "system_access", "self_control",

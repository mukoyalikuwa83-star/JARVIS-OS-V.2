...
def _format_research_report(content: str, goal: str) -> str:
    """
    Wrap gathered research into a clean report before saving.
...
The following report was generated from live research results gathered by the assistant. It consolidates the most relevant findings into a single saved document for later review.
...
- Prefer tools that are actively maintained and work well on macOS if this is being used inside the the assistant environment.
